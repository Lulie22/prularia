...
public class UitgaandeLevering {
    ...
    public UitgaandeLevering(long uitgaandeLeveringsId, long bestelId, LocalDate vertrekDatum, LocalDate aankomstDatum, String trackingCode, long klantId, long uitgaandeLeveringsStatusId) {
